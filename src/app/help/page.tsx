...
const GLOSSARY = [
  ...
  {
    term: 'データ出典',
    definition: '人口: 総務省統計局 e-Stat（https://www.e-stat.go.jp/）の令和2年国勢調査データ。マンション取引: 国土交通省 不動産情報ライブラリ 不動産価格（成約価格）情報 XIT001。駅乗降客数: 国土交通省 不動産情報ライブラリ 国土数値情報 駅別乗降客数 XKT015（令和5年度＝2023年データ）。不動産情報ライブラリ: https://www.reinfolib.mlit.go.jp/',
  },
]
