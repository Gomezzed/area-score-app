    ...
    <LegalShell title="利用規約" established="2026年6月11日 制定">
      ...
      <section>
        ...
        <ol className={ol}>
          ...
          <li>契約プランに定められたID数の範囲を超えて、認証情報を第三者に共有・譲渡・貸与してはなりません。</li>
        </ol>
      </section>
      ...
      <section>
        ...
        <ol className={ol}>
          <li>利用者は、本サービスの対価として、当方が別途定める利用料金（税抜表示・別途消費税）を、当方の指定する方法（クレジットカード決済）により支払うものとします。</li>
      ...
      <section>
        ...
        <ol className={ol}>
          ...
          <li>当社が試験的に提供する機能は、予告なく仕様変更・提供終了となる場合があります。</li>
        </ol>
      </section>
      ...
      <section>
        <LegalHeading>第12条（準拠法・裁判管轄）</LegalHeading>
        <LegalParagraph>
