...
const FAQS = [
  {
    q: '先行申込はどのように行えますか？',
    a: 'ページ下部のお問い合わせフォームよりお申し込みください。担当より折り返しご案内し、アカウントを発行します。2026年8月31日までにご契約いただいた価格は、契約継続中ずっと据え置かれます。',
  },
  {
  ...
  },
  {
    ...
    a: 'Freeプランでは上位3エリアの閲覧のみご利用いただけます。全エリアの閲覧やレポート出力をご希望の場合は、Starter以上のプランをご検討ください。',
  },
  {
    q: '機能は今後も追加されますか？',
    a: 'はい。エリアスコアは随時アップデートを行っており、新機能・データ・対応エリアを継続的に拡充しています。最新情報はご契約者さまに随時ご案内いたします。',
  },
  {
    q: '対応エリアはどこまでですか？',
