...
- 対象（D135 拡張後）: 既存8（豊橋23201 / 岡崎23202 / 刈谷23210 / 豊田23211 / 安城23212 / 知立23225 / 高浜23227 / 鹿児島46201）
  ＋ 愛知6市（瀬戸23204 / 西尾23213 / 尾張旭23226 / 岩倉23228 / 北名古屋23234 / 長久手23238）
  ＋ 名古屋市16区（案A＝区コード 23101〜23116 / 市コード23100 へ丸めない）
  ＋ 東郷町（愛知郡東郷町 23302・郡名の有無両表記を吸収）。
  唯一の正は `TARGET_MUNIS`。`src/lib/address/target-munis.ts` と 2ファイル同時更新（O38）。
  D135 の PO 実行手順は `docs/d135_coverage_etl_runbook.md` を参照。
