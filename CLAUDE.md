...
- `municipalities`(1,916)：ダッシュボードの主。population_history・station_passengers_total等。
...
- **新規作成予定**：`public.town_monthly_metrics`（T3）／ `public.market_metrics`（T4・value_type=confirmed/reference分離）。
